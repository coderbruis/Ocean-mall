...
public class Product {
    ...
    public Product(Integer id, Integer categoryId, String name, String subtitle, String mainImage, String subImages, String detail, BigDecimal price, Integer stock, Integer status, Integer comments, Date createTime, Date updateTime, BigDecimal score) {
        this.id = id;
